...
# { "signal": [
#  { "name": "clk",   "wave": "P....." },
#  { "name": "signal1",  "wave": "======", "data": Input1_string},
#  { "name": "signal2", "wave": "======", "data": "2 3 11 22 32 1"},
#  { "name": "Output",  "wave": "======","data":"3 5 16 33 44 24" },
# ]}""")
#     svg.saveas("demo1.png")

    # Save the SVG code to a file
    # with open("timing_diagram.svg", "w") as f:
    #     f.write(svg_code)
    # Input=myInput
    # carcolor="white"
    # file = open("text.txt", "w")
    # file.write("myInput="+ str(myInput) + "\n" +"myOutput="+str(myoutput) + "\n" + "TimeStamp="+str([mytimestamp]))
    # file.close
